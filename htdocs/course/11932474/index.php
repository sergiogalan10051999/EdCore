...
<html>
<head>
    <title>Physical Education and Health</title>
    <style>
        body {
            margin: 0;
...
<body>
    <div class="main-container" id="main-container">
        <img src="/resources/PEAHBanner.jpg" alt="Banner Image" class="banner">
        ...
        <section id="section1">
            ...
            <div class="progress-container">
                <div class="progress-item">
                    <canvas id="progressChart" data-percentage="70" data-color="blue" data-type="percentage" width="200" height="200"></canvas>
                    <p>Progress</p>
                </div>
                <div class="progress-item">
                    <canvas id="masteryChart" data-percentage="1.0" data-color="yellow" data-type="score" width="200" height="200"></canvas>
                    <p>Score</p>
                </div>
            </div>
        </section>
        ...
        <section id="section3">
            <h1>News</h1>
            <ul>
                <li>News is kind of silent around Here...</li>
            </ul>
        </section>
    </div>
